...
![k6 負載測試類型概覽圖](https://grafana.com/media/docs/k6-oss/chart-load-test-types-overview.png?w=900)
...
- [k6 官方文件](https://grafana.com/docs/k6/latest/using-k6/)
- [GitLab CI 負載效能測試](https://docs.gitlab.com/ci/testing/load_performance_testing/)
- [Google PageSpeed Insights API](https://developers.google.com/speed/docs/insights/v5/about?hl=zh-tw)
- [網站回應時間研究](https://www.nngroup.com/articles/website-response-times/)
- [k6 負載測試最佳實務](https://k6.io/our-beliefs/#load-test-in-a-pre-production-environment)
- [GitLab 品質與效能團隊](https://gitlab.com/gitlab-org/quality/performance)
