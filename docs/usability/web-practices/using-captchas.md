...
CAPTCHAs 會讓部分的人較難使用我們的服務，包括[身心障礙者](../accessibility/making-your-service-accessible-an-introduction.md#從一開始就考慮無障礙性)。第三方的 CAPTCHA 服務也會帶來額外風險，包括：
...
- [監控資料交換動態](../../high-availability/testing-compliance/monitor-service-status.md)
...
- [使用 cookies 和類似技術的工作指南](../web-practices/working-with-cookies-and-similar-technologies.md)
