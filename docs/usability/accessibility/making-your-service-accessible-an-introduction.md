...
- 研究最常用的[輔助科技](../frontend-performance/testing-with-assistive-technologies.md)- 包括螢幕放大鏡、螢幕報讀器和語音辨識工具
...
您還可以透過[與身心障礙使用者進行研究會談](../accessibility/running-research-sessions-with-people-with-disabilities.md)來改進您的設計。
...
[與身心障礙使用者一起進行研究會談](../accessibility/running-research-sessions-with-people-with-disabilities.md)有助您檢查正在建立的內容具備無障礙性。
